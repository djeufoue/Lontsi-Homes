...
static RentReceiptDto ReceiptLayoutFixture()
{
    ...
    var qrType = typeof(ApplicationDbContext).Assembly.GetType("RentHub.API.Services.Receipts.SimpleQrCodeGenerator")!;
...
{
    var resolve = typeof(RentHub.API.Controllers.AccountController).GetMethod("ResolveLandlordOnboardingStep",
    ...
    var sanitize = typeof(RentHub.API.Controllers.AccountController).GetMethod("SanitizeOnboardingStatusForAnonymous",
        System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static)!;
    ...
    var buildSteps = typeof(RentHub.API.Controllers.AdminUsersController).GetMethod("BuildStepDtos",
        System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static)!;
...
static void TestWhatsAppNumberChange()
{
    ...
    using var context = new ApplicationDbContext(new DbContextOptionsBuilder<ApplicationDbContext>()
        .UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=RentHubModelCheck;Trusted_Connection=True;").Options);
    context.Attach(user);
...
static async Task TestReceiptMedia()
{
    ...
    var controller = new RentHub.API.Controllers.ReceiptsController(context, service, media)
