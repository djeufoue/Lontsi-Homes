...
$source = Get-Content -LiteralPath (Join-Path $PSScriptRoot '../RentHub.API/Migrations/20260911020456_AddInfobipMessagingAndWhatsAppConsent.cs') -Raw
...
$database = 'RentHubMigrationRegression_' + [guid]::NewGuid().ToString('N')
