...
namespace LontsiHomes.Portal.Controllers
{
    ...
    public class TenanciesController : Controller
    {
        ...
        public TenanciesController(LontsiHomesApiClient api, ILogger<TenanciesController> logger)
        {
            _api = api;
            _logger = logger;
        }
        ...
        private void RegenerateRentPeriods(TenancyCreateDraft draft)
        {
            ...
            if (draft.ImportMode == RentPaymentImportModeEnum.AllPastPeriodsPaidBeforeLontsiHomes)
            {
        ...
        {
            var draftRoot = Path.Combine(Path.GetTempPath(), "LontsiHomesTenancyDrafts");
