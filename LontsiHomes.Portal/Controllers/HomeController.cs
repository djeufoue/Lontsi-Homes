...
namespace LontsiHomes.Portal.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, LontsiHomesApiClient api, IConfiguration configuration)
        {
            _logger = logger;
            _api = api;
