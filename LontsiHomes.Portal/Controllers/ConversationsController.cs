...
using LontsiHomes.Portal.ViewModels.Conversations;
...
namespace LontsiHomes.Portal.Controllers
{
    ...
    public class ConversationsController : Controller
    {
        ...
        public ConversationsController(LontsiHomesApiClient api, ILogger<ConversationsController> logger, IHubContext<WorkspaceHub> hub)
        {
            _api = api;
            _logger = logger;
            _hub = hub;
