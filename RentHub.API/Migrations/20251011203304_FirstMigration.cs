        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxApartmentsPerProperty = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositPrice = table.Column<decimal>(type: "decimal(14,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PropertyManagerAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyManagerAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyManagerAssignments_AspNetUsers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropertyManagerAssignments_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandlordId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RentDueReminderDays = table.Column<int>(type: "int", nullable: false),
                    RentUnpaidReminderDays = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReminderSettings_AspNetUsers_LandlordId",
                        column: x => x.LandlordId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReminderSettings_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentOwners_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Documents_AspNetUsers_DeletedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposedEndDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenancyExtensionRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenancyExtensionRequests_AspNetUsers_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TenancyExtensionRequests_AspNetUsers_RequestedById",
                        column: x => x.RequestedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenancyExtensionRequests_Tenancies_TenancyId",
                        column: x => x.TenancyId,
                        principalTable: "Tenancies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenancyMembers_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentOwners_ApartmentId_OwnerId",
                table: "ApartmentOwners",
                columns: new[] { "ApartmentId", "OwnerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyManagerAssignments_ManagerId",
                table: "PropertyManagerAssignments",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyManagerAssignments_PropertyId_ManagerId",
                table: "PropertyManagerAssignments",
                columns: new[] { "PropertyId", "ManagerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReminderSettings_PropertyId",
                table: "ReminderSettings",
                column: "PropertyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenancyExtensionRequests_ApprovedById",
                table: "TenancyExtensionRequests",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_TenancyExtensionRequests_RequestedById",
                table: "TenancyExtensionRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenancyMembers_MemberId",
